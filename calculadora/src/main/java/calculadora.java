...
Double resultado; 
    ...
    private void jButtonSinActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    ...
    private void jButtonCosActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
        if(!txtmostrar.getText().equals(""))
        {
            valor1=txtmostrar.getText();
...
public static String operaciones(String valor1, String valor2, String signo)
{
    ...
    else if(signo.equals("Tan"))
    {
     ...
     else if(signo.equals("Sin"))
    {
        
        resultado=Math.sin(Double.parseDouble(valor1));
    }
  ...
  if(!txtmostrar.getText().equals(""))
    ...
    private void jButtonTanActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
          if(!txtmostrar.getText().equals(""))
        {
            valor1=txtmostrar.getText();
